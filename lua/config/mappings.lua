...
vim.keymap.set('n', '<F6>', '<Cmd>DapClearBreakpoints<CR>', { desc = 'Clear' })
vim.keymap.set('n', '<C-5>', function()
  local input = vim.fn.input('')
  require 'dap'.toggle_breakpoint(input)
end, { desc = 'Toggle' })
vim.keymap.set('n', '<F8>', '<Cmd>DapTerminate<CR>', { desc = 'Terminate' })
vim.keymap.set('n', '<F9>', '<Cmd>DapStepOut<CR>', { desc = 'Step Out' })
vim.keymap.set('n', '<F10>', '<Cmd>DapStepOver<CR>', { desc = 'Step Over' })
vim.keymap.set('n', '<F11>', '<Cmd>DapContinue<CR>', { desc = 'Continue' })
vim.keymap.set('n', '<F12>', '<Cmd>DapStepInto<CR>', { desc = 'Step Into' })
